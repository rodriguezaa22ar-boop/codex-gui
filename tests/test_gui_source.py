...
class GuiSourceTests(unittest.TestCase):
    ...
    def test_mesh_launch_pulse_focus_controls_are_wired(self) -> None:
        ...
        apply_focus = _method_named(tree, "_apply_mesh_launch_console_focus_filter_style")
        ...
        self.assertIn("chip-selected", ast.unparse(apply_focus))
        self.assertIn("mesh_launch_pulse_ready_chip", ast.unparse(apply_focus))
