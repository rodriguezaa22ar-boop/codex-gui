...
class GuiSourceTests(unittest.TestCase):
    ...
    def test_mesh_launch_pulse_focus_controls_are_wired(self) -> None:
        ...
        render_console = _method_named(tree, "render_mesh_launch_console")
        focus_history = _method_named(tree, "_mesh_launch_console_focus_history_text")
        record_history = _method_named(tree, "_record_mesh_launch_console_focus_history")
        preset_changed = _method_named(tree, "on_mesh_launch_focus_preset_changed")
        preset_options = _method_named(tree, "_mesh_launch_console_focus_preset_options")
        sync_preset = _method_named(tree, "_sync_mesh_launch_console_focus_preset")
        filter_value = _method_named(tree, "_mesh_launch_console_focus_filter_value")
        focus_back = _method_named(tree, "on_mesh_launch_focus_back")
        ...
        self.assertIn("mesh_launch_console_focus_history_label", build)
        self.assertIn("mesh_launch_console_focus_back_button", build)
        self.assertIn("mesh_launch_console_focus_preset_dropdown", build)
        ...
        self.assertIn("_mesh_launch_console_focus_history_text", ast.unparse(render_console))
        self.assertIn("Focus trail", ast.unparse(focus_history))
        self.assertIn("_record_mesh_launch_console_focus_history", ast.unparse(set_focus))
        self.assertIn("_mesh_launch_console_focus_name", ast.unparse(focus_history))
        self.assertIn("mesh_launch_console_focus_history", ast.unparse(record_history))
        self.assertIn("on_mesh_launch_focus_back", ast.unparse(focus_back))
        self.assertIn("on_mesh_launch_focus_preset_changed", build)
        self.assertIn("dropdown_value(", ast.unparse(preset_changed))
        ...
        self.assertIn("_mesh_launch_console_focus_preset_options", ast.unparse(preset_options))
        self.assertIn("notify::selected", build)
        self.assertIn("_sync_mesh_launch_console_focus_preset", ast.unparse(sync_preset))
        self.assertIn("_mesh_launch_console_focus_filter_value", ast.unparse(filter_value))
        self.assertIn("record_history=False", ast.unparse(focus_back))

    def test_mesh_launch_focus_keyboard_actions_are_registered(self) -> None:
        source = Path("codex_gui.py").read_text(encoding="utf-8")
        tree = ast.parse(source)

        install_actions = _method_named(tree, "install_actions")
        focus_cycle = _method_named(tree, "on_mesh_launch_focus_cycle")
        focus_all = _method_named(tree, "on_mesh_launch_focus_all")
        focus_blocked = _method_named(tree, "on_mesh_launch_focus_blocked")
        focus_ready = _method_named(tree, "on_mesh_launch_focus_ready")
        focus_review = _method_named(tree, "on_mesh_launch_focus_review")
        focus_offline = _method_named(tree, "on_mesh_launch_focus_offline")
        focus_back = _method_named(tree, "on_mesh_launch_focus_back")
        set_focus = _method_named(tree, "_set_mesh_launch_console_focus_filter")

        install_code = ast.unparse(install_actions)
        self.assertIn("mesh-launch-focus-cycle", install_code)
        self.assertIn("mesh-launch-focus-ready", install_code)
        self.assertIn("mesh-launch-focus-all", install_code)
        self.assertIn("mesh-launch-focus-blocked", install_code)
        self.assertIn("mesh-launch-focus-review", install_code)
        self.assertIn("mesh-launch-focus-offline", install_code)
        self.assertIn("mesh-launch-focus-back", install_code)
        self.assertIn("app.mesh-launch-focus-cycle", install_code)
        self.assertIn("app.mesh-launch-focus-ready", install_code)
        self.assertIn("app.mesh-launch-focus-all", install_code)
        self.assertIn("app.mesh-launch-focus-blocked", install_code)
        self.assertIn("app.mesh-launch-focus-review", install_code)
        self.assertIn("app.mesh-launch-focus-offline", install_code)
        self.assertIn("app.mesh-launch-focus-back", install_code)
        self.assertIn("def on_mesh_launch_focus_cycle", ast.unparse(focus_cycle))
        self.assertIn("def on_mesh_launch_focus_all", ast.unparse(focus_all))
        self.assertIn("def on_mesh_launch_focus_blocked", ast.unparse(focus_blocked))
        self.assertIn("def on_mesh_launch_focus_ready", ast.unparse(focus_ready))
        self.assertIn("def on_mesh_launch_focus_review", ast.unparse(focus_review))
        self.assertIn("def on_mesh_launch_focus_offline", ast.unparse(focus_offline))
        self.assertIn("def on_mesh_launch_focus_back", ast.unparse(focus_back))
        self.assertIn("_set_mesh_launch_console_focus_filter", ast.unparse(focus_all))
        self.assertIn("_set_mesh_launch_console_focus_filter", ast.unparse(focus_blocked))
        self.assertIn("_set_mesh_launch_console_focus_filter", ast.unparse(focus_ready))
        self.assertIn("_set_mesh_launch_console_focus_filter", ast.unparse(focus_review))
